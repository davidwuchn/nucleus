...
**New to Nucleus?**
1. Read [NUCLEUS_GUIDE.md](NUCLEUS_GUIDE.md) for framework basics and practical workflows
2. Reference [LOCAL_CHANGES.md](LOCAL_CHANGES.md) for complete framework specification
...
- **[AGENTS.md](AGENTS.md)** - Formal framework specification and Eight Keys with λ-calculus notation
...
### Framework Ecosystem
- **[LOCAL_CHANGES.md](LOCAL_CHANGES.md)**: Complete framework specification and local changes tracking
- **NUCLEUS_GUIDE.md**: Framework basics and practical workflows (English)
...
### Learning Path
1. **Start with** [NUCLEUS_GUIDE.md] for framework basics (English)
...
4. **Reference** [LOCAL_CHANGES.md] for complete framework specification
